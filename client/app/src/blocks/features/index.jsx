...
const Feature16 = () => {
  return (
    <section className="py-16 bg-gradient-to-b from-neutral-950 via-black to-neutral-900 text-white">
      <div className="container">
        <div className="grid gap-8 lg:grid-cols-3">
          
          <div className="rounded-2xl bg-neutral-800/60 p-8 shadow-lg hover:shadow-2xl transition-all duration-300">
